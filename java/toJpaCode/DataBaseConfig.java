...
@EnableJpaRepositories(
	    basePackages="com.happy.people.core.repo",  //repository를 관리할 패키지 명시
...
public class DataBaseConfig {
	...
	public DataSource defaultDataSource() {
	    ...
	    dataSourceConfig.setJdbcUrl("jdbc:mysql://127.0.0.1:3306/{databaseName}?characterEncoding=UTF-8&serverTimezone=UTC&allowMultiQueries=true");
	    dataSourceConfig.setUsername("id");
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
	  ...
	  builder.dataSource(defaultDataSource())
	    .packages("com.happy.people.core.domain")
